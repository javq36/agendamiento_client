      ...
      <Container maxWidth="md" sx={{ marginBottom: 20, overflow: 'hidden' }}>
        <motion.div
          ...
          <motion.div layout
            ...
            <Paper elevation={4} className="contactanos" style={{ overflow: 'hidden', marginTop: 15, marginBottom: 20, boxShadow: "10px 10px 0 rgba(0, 0, 0, 0.2)"}}>
              <h3 style={{ textAlign: 'center', paddingTop: '10px', marginBottom: '8px' }}>Contactanos</h3>
              <Container maxWidth="lg" style={{}}>
                <p style={{textAlign: 'justify'}}>
                  <span>Empresas Nortesantandereana ubicada en una zona comercial estratégica. Contamos con años de experiencia en el sector de venta de <strong>carros, SUV´s, camionetas, PickUp, Utilitarios, motocicletas</strong> entre otros, y en posventa: <strong>repuestos y taller</strong> especializado en las marcas: <strong>Ford, FIAT, Jeep, RAM, Dodge, Peugeot, Foton y Bajaj.</strong> Somos el concesionario multimarcas <strong>en Cúcuta</strong> y la Zona de frontera con Venezuela.</span>
                </p>
              </Container>
